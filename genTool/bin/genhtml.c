...
void print_doc_head( FILE ** output_file, int topic_type_id, char * html_title, int * single_page_index, int topic_seq[][NORMALLEN] ) {
    ...
    fprintf(output_file[topic_type_id], "<script type=\"text/javascript\" src=\"/js/search_keyword.js\"></script><script type=\"text/javascript\" src=\"/js/snowstorm-min.js\"></script><link href=\"/css/main.css\" type=\"text/css\" rel=\"stylesheet\" />\n");
