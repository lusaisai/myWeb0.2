...
**
** Created: Fri Feb 1 22:51:10 2013
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_2 = new QGridLayout(topicGroupBox);
        ...
        sizePolicy1.setHeightForWidth(topicTableView->sizePolicy().hasHeightForWidth());
        topicTableView->setSizePolicy(sizePolicy1);

        gridLayout_2->addWidget(topicTableView, 0, 0, 1, 1);
        ...
        gridLayout_5->addWidget(topicGroupBox, 0, 0, 1, 2);
        ...
        sizePolicy1.setHeightForWidth(listTableView->sizePolicy().hasHeightForWidth());
        listTableView->setSizePolicy(sizePolicy1);
        ...
        gridLayout_5->addWidget(listGroupBox, 2, 0, 1, 2);
